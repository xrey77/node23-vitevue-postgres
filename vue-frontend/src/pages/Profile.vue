<template>
    ...
    export default defineComponent({
        ...
        methods: {
            getUserprofile: async function() {
              await api.get(`api/getuserid/${this.userid}`, { headers: {
                ...
                .then((res: any) => {
                        ...
                        this.profilepic = res.data.user.userpic;
            ...
            enableMFA: function() {
                const data =JSON.stringify({id: this.userid, Twofactorenabled: true });
            ...
            disableMFA: function() {
                const data =JSON.stringify({id: this.userid, Twofactorenabled: false });
                api.patch('api/mfa/activate', data, { headers: {
                    Authorization: `Bearer ${this.token}`
                }} )
                .then((res: any) => {
